...
import { getGridRect, getText, updateText } from "./helpers";
import * as turf from "@turf/turf";
import TopNav from "../TopNav";

import "./studio.css";
import DrawButton from "./darw-button";
...
class PlanifyDraw extends Component {
  ...
  componentDidMount() {
    ...
    this.app.view.addEventListener("wheel", (e) => {
      ...
      new_pitch = Math.max(2, Math.min(new_pitch, 10));

      this.grid_pitch = new_pitch;
      this.grid_pitch_big = new_pitch * 2;
          ...
          <div className={"toolbar element"}>
            <div className={"toolbar-up"}>
              <div class="round-button div-buttons">
                ...
                <img
                  onClick={this.setDoorMode}
                  id="door-image"
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Circle-icons-door.svg/1024px-Circle-icons-door.svg.png"
                  alt="Round "
                ></img>
              </div>
            ...
            <div className={"toolbar-down"}>
              <DrawButton getPlanData={this.getPlanData} />
            </div>
          </div>
